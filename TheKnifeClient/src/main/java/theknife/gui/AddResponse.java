...
public final class AddResponse extends javax.swing.JPanel 
{
    ...
    private void initEvents     () 
    {
      ...
      {
        @Override
        public void mouseClicked        (java.awt.event.MouseEvent e)       {try {
            btn_add_MouseClicked           (e);
            } catch (IOException ex) {
                System.getLogger(AddResponse.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
    ...
    private void btn_add_MouseClicked           (java.awt.event.MouseEvent e) throws IOException, ClassNotFoundException 
    {
      if(!txt_content.getText().trim().isEmpty())
      {
        ...
        Response response = new Response(review     .getID(),
