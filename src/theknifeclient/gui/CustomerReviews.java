...
public final class CustomerReviews extends javax.swing.JPanel {
     ...
     */
    public CustomerReviews(Controller controller) throws IOException, ClassNotFoundException {
        initComponents();
     ...
     */
    private void initCustomerReviews() throws IOException, ClassNotFoundException {
        ...
        btn_remove.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                try {
                    ...
                    System.getLogger(CustomerReviews.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
     ...
     * @param e the mouse event triggered by clicking the button 
     */
    private void btn_remove_MouseClicked(java.awt.event.MouseEvent e) throws IOException, ClassNotFoundException 
    {
        Review review;
        if ((review = controller.getSelectedReview()) == null) 
    ...
    private void btn_edit_MouseClicked(java.awt.event.MouseEvent e) 
    {
        ...
        {
            for(int i=0; i<reviews.getList().size(); i++)
              if(reviews.getList().get(i).getID() == review.getID())
              {
                reviews.getList().set(i, review);
                break;
              }
     ...
     */
    private void getCustomerReviews() throws IOException, ClassNotFoundException 
    {
      reviews = controller.getCustomerReviews();
    }
    
    /**
     * Updates the {@link ListReview} {@code JPanel} of the customer.
     */
    private void updatePanelReviews() throws IOException, ClassNotFoundException {
