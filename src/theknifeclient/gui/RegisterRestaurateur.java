...
public class RegisterRestaurateur extends CustomJPanel 
{
        ...
        btn_register.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                try {
                    ...
                    System.getLogger(RegisterRestaurateur.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
     ...
     */
    private void btn_register_MouseClicked(java.awt.event.MouseEvent e) throws IOException, ClassNotFoundException, Exception 
    {
      boolean error = false;
