...
public class RestaurantGUI extends javax.swing.JPanel
{
        ...
        btn_addFavourite.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                try {
                    ...
                    System.getLogger(RestaurantGUI.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
     ...
     * @param e the mouse event triggered by clicking the button 
     */
    private void btn_addFavourite_MouseClicked(java.awt.event.MouseEvent e) throws IOException, ClassNotFoundException 
    {
      if(customer != null)
      {
        favoriteClicked = !favoriteClicked;
        ...
        {          
          ...
          controller.addFavourite(restaurant.getId(), customer.getId());
        }
        else
        {          
          customer.getListFavorite().remove(restaurant.getId());
          btn_addFavourite.setCharacter(FULL_STAR);
          controller.removeFavourite(restaurant.getId(), customer.getId());
        }
      }
      else
      {
